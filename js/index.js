$(document).ready(function(){
	...
	$("#more-info").click(function(){
		$("#new-add-info").after("<div class=row><div class=col-sm-6><img class=img-top-bor width=100% src=img/active-img1.jpg><p class=ac-main-text>在網路世界裡，每部裝置彼此連結與傳遞訊息，都必須仰賴各自獨特的網際協定（IP）位址，才不會在資訊流通時彼此混淆，但隨著全球網際網路快速發展，各式裝置數量如雨後春筍般增生，再加上近年來物聯網、車聯網等技術推陳出新，造成IPv4位址面臨用罄危機。</p><div class=text-center><button class=ac-btn hvr-back-pulse>瞭解更多</button></div></div><div class=col-sm-6><img class=img-top-bor width=100% src=img/active-img2.jpg><p class=ac-main-text>TWNIC於107年5月28日(一)下午2:00正式上線推出全新「at.tw 翻轉域名實驗計畫服務」，新型態at.tw域名+網頁轉址服務的結合，突破以往域名註冊思維，以簡單快速的域名註冊流程，搭配網頁轉址服務的簡易設定，提供網路使用者新型態網路架站服務體驗。</p><div class=text-center><button class=ac-btn hvr-back-pulse>瞭解更多</button></div></div></div><div class=row id=new-add-info><div class=col-sm-6><img class=img-top-bor width=100% src=img/active-img1.jpg><p class=ac-main-text>在網路世界裡，每部裝置彼此連結與傳遞訊息，都必須仰賴各自獨特的網際協定（IP）位址，才不會在資訊流通時彼此混淆，但隨著全球網際網路快速發展，各式裝置數量如雨後春筍般增生，再加上近年來物聯網、車聯網等技術推陳出新，造成IPv4位址面臨用罄危機。</p><div class=text-center><button class=ac-btn hvr-back-pulse>瞭解更多</button></div></div><div class=col-sm-6><img class=img-top-bor width=100% src=img/active-img2.jpg><p class=ac-main-text>TWNIC於107年5月28日(一)下午2:00正式上線推出全新「at.tw 翻轉域名實驗計畫服務」，新型態at.tw域名+網頁轉址服務的結合，突破以往域名註冊思維，以簡單快速的域名註冊流程，搭配網頁轉址服務的簡易設定，提供網路使用者新型態網路架站服務體驗。</p><div class=text-center><button class=ac-btn hvr-back-pulse>瞭解更多</button></div></div></div>");
